...
IMPLICIT NONE
  ...
  !NDD=0
  !WORKK=0D0
  CALL FILL_MAT_KER<<<CEILING(REAL(NODEID(-2))/4),4>>>(LNODE,NODN,NODEID,NWALLID,COORX,COORY,COORZ,NLMAX,MBA,KW,R1,DDR,DT,FB)
...
SUBROUTINE VELOCITY_SMOOTH_SHA(LNODE,NODN,NODEID,NWALLID,&
   ...
   !NNN=0
   !WW=0
   CALL VELOCITY_SMOOTH_SHA_K<<<CEILING(REAL(NODEID(-1))/2),2>>>(KW,LNODE,NODN,NODEID,NWALLID,NLMAX,MBA,COORX,COORY,COORZ,R1,DDR)
   I=cudaDeviceSynchronize()
